    ...
    extends JMLValueBagSpecs implements JMLCollection
{
    ...
    /*@  public normal_behavior
      ...
      @    |}
      @*/
    public /*@ non_null extract @*/ JMLValueBag insert(/*@ nullable @*/ JMLType elem)
	...
	//@    assume cnt >= 0;
      //@    assume elem != null;
      //@    assume int_size() < Integer.MAX_VALUE - cnt;
      //@    JMLType copy = (JMLType) elem.clone();
	...
	//@    refining normal_behavior
      ...
      //@      ensures (\forall JMLType e; e != copy;
      //@                       countObject(e)
      //@                        == returnVal.countObject(e));
      //@      ensures returnVal.countObject(copy) == cnt;
      //@      ensures returnVal.int_size() == int_size() + cnt;
    {
        if (cnt == 0) {
            returnVal = this;
        }
        	...
        	// cons() clones if necessary
		returnVal = new JMLValueBag( JMLValueBagEntryNode.cons(entry, new_list),
                	                      size + cnt );
	}
	}
