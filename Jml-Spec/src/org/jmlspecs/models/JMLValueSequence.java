// @(#)$Id: JMLSequence.java-generic,v 1.81 2008/10/24 18:07:50 smshaner Exp $
    ...
    extends JMLValueSequenceSpecs implements JMLCollection
{
    ...
    public JMLValueSequence (JMLType e)
      ...
      @    behavior
      @      assignable this.*;
      @      ensures objectAt(0) == copy && int_size() == 1;
      @  }
          @*/
    {
                ...
                JMLValueSequence returnVal = null;
                   ...
                   @        && returnVal.int_length() == int_length() + 1; @*/
                 {
                  ...
                  JMLListValueNode new_list
                      = theSeq.insertBefore(beforeThisOne, item);
                  //@ assume new_list != null;
		  returnVal = new JMLValueSequence(new_list, int_length()+1);
                }
                return returnVal;
            }
        } else {
