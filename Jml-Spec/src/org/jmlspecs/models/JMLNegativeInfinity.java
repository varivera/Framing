// @(#)$Id: JMLNegativeInfinity.java,v 1.15 2008/10/24 18:07:50 smshaner Exp $
...
public /*@ pure @*/ class JMLNegativeInfinity extends JMLInfiniteIntegerClass {
	...
	/*@    refining normal_behavior
	  @      ensures !is_infinite ==> (\result == finite_value.toString(radix));
	  @      ensures (is_infinite && nonnegative) ==> (\result == "Infinity");
	  @      ensures (is_infinite && !nonnegative) ==> (\result == "-Infinity");
	  @*/
	{
	    return toString(); 
