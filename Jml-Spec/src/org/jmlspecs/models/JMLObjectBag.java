    ...
    implements JMLCollection
{
    ...
    /*@  public normal_behavior
      ...
      @    |}
      @*/
    public /*@ non_null extract @*/ JMLObjectBag insert(/*@ nullable @*/ Object elem)
	...
	JMLObjectBag returnVal = null;
        ...
        if (cnt == 0) {
        	...
        	// cons() clones if necessary
		returnVal = new JMLObjectBag( JMLObjectBagEntryNode.cons(entry, new_list),
                	                      size + cnt );
	}
